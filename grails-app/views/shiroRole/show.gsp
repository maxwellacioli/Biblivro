...
<html>
    ...
    <body>
        ...
        <div id="show-shiroRole" class="content scaffold-show" role="main">
            ...
            <f:display bean="shiroRole" />
            <g:form resource="${this.shiroRole}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.shiroRole}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
