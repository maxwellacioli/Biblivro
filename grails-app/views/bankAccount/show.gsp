...
<html>
    ...
    <body>
        ...
        <div id="show-bankAccount" class="content scaffold-show" role="main">
            ...
            <f:display bean="bankAccount" />
            <g:form resource="${this.bankAccount}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.bankAccount}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
