...
<html>
    ...
    <body>
        ...
        <div id="show-commentary" class="content scaffold-show" role="main">
            ...
            <f:display bean="commentary" />
            <g:form resource="${this.commentary}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.commentary}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
